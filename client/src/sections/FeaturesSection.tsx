...
<SectionTitle
  ...
  text3="AI-powered tools that help you design better thumbnails in less time."
/>            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-4 mt-16 px-6">
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
Our AI understands your needs and provides the best solutions for your thumbnails. With Thumblify, you can create high-converting designs in seconds.                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <h3 className="text-[24px]/7.5 text-slate-300 font-medium mt-6">Create better thumbnails with creativity</h3>
                        <p className="text-slate-300 mt-2">Create better thumbnails with creativity</p>
