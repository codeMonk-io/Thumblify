...
const PreviewPanel = ({
  ...
  const onDownload = () => {
    ...
    // 'fl_attachment' is the correct Cloudinary flag for forcing downloads
    link.href = thumbnail?.image_url.replace('/upload','/upload/fl_attachment');
    link.setAttribute("download", `${thumbnail.title.replace(/\s+/g, '_')}_thumbnail.png`);
  ...
  return (
    <div className="relative mx-auto w-full max-w-lg">
      <div className={`relative overflow-hidden rounded-xl bg-zinc-900 ${aspectClasses[aspectRatio]}`}>
